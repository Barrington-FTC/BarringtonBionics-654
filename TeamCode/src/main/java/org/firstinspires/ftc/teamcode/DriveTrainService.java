...
public class DriveTrainService {
    ...
    public static void moveRobot(DcMotor leftFrontDrive, DcMotor rightFrontDrive, DcMotor leftBackDrive, DcMotor rightBackDrive){
    ...
    private static double calculateYaw() {
