...
public class AutoOPBlue extends LinearOpMode {
    ...
    static int[] ordera = { 2, 1, 1 };
    static int[] orderb = { 1, 2, 1 };
    static int[] orderc = { 1, 1, 2 };
    static int[] targetOrder = null;
    ...
    public void runOpMode() {
        ...
        flywheelPID = new FlywheelPIDController(0.005, 0.001, 0.0004, 0.001);
        // threads
    ...
    public static void solveShot(double xTarget, double yTarget, double launchAngle) {
        ...
        VRPM = Math.max(1500, Math.min(calculatedRPM, 4800));
    }
    ...
    public static int[] getBallOrder(){
        return targetOrder;
    }
